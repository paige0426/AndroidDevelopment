...
/*    *//**
     ...
     *//*
    public static List<Restaurant> getRestaurantData(Context context) {
        List<Restaurant> restaurantData = new ArrayList<Restaurant>();
        for (int i = 0; i < 10; ++i) {
            restaurantData.add(
                    new Restaurant("Restaurant", "1184 W valley Blvd, CA 90101", "New American", i * 7 + 7, i * 5 - 5));
        ...
        try {
            ...
            for (int i = 0; i < businesses.length(); i++) {
                ...
                if (business != null) {
                    ...
                    restaurants.add(
                            new Restaurant(name, address, type, lat, lng, thumbnail, rating, isVisited, businessId));
                }
            }
            return restaurants;
